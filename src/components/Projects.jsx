          ...
          {PROJECTS.map((project, index) => (
            ...
            >
              ...
              <div className="relative flex flex-col lg:flex-row">
                ...
                {/* CONTENT */}
                <motion.div initial={{ opacity: 0, x: 50 }}   // ✅ start from right
                  whileInView={{ opacity: 1, x: 0 }} // ✅ move to normal
                  transition={{ duration: 0.6 }}
                  className="relative p-6 flex flex-col justify-between w-full lg:w-1/2">
                  ...
                  <div className="flex gap-3 mt-6 flex-wrap">
                    ...
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="px-5 py-2 text-sm rounded-full font-medium text-white 
