...
const Skills = () => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-[-100px] right-[-100px] w-[400px] h-[400px] bg-blue-500/10 blur-[120px] rounded-full"></div>
      ...
      >
        {skills.map((group, index) => (
          <motion.div
            ...
            shadow-xl group hover:border-purple-400/40 transition"
          >

            {/* 🔥 Glow */}
            <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-purple-500/10 to-blue-500/10 blur-xl opacity-0 group-hover:opacity-100 transition"></div>
